...
class UploadFileModal extends React.Component {
  ...
  render() {
    return ReactDOM.createPortal(
      <div className="upload-file-modal" style={{ display: this.state.visiable ? "flex" : "none" }}>
        <div className="modal-content" style={{ ...this.props.style }}>
          <Row>
            ...
            <Col span={24}>
              <Progress percent={this.state.progress} style={{ padding: "0x", margin: "0px" }} />
            </Col>
            <Col
              span={24}
            ...
            >
              {this.state.error ? (
                <Typography.Text style={{ float: "left", color: "red" }}> {this.state.error} </Typography.Text>
              ) : (
                <>
