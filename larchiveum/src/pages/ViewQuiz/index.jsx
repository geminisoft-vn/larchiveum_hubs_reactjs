...
import { Breadcrumb, Button, Card, Col, Layout, Menu, Row, Spin } from "antd";

import GettingStarted from "src/pages/ViewQuiz/components/GettingStarted";
        ...
        <>
          {isError ? (
            ...
            <>
              ...
              {quizStep == QUIZ_STEPS.RESULT && (
                <Result quizResultId={quizResult.id} />
              )}
            </>
          )}
        </>
