    ...
    <Modal
      ...
      >
          ...
          rules={[
            {
              required: true,
              message: t(
                "content.QUIZ_TAB__POPUP_CREATE_QUIZ__TITLE_INPUT_WARNING_MESSAGE"
              ),
            },
          ]}
        >
          <Input
            ...
            name="title"
            placeholder={t(
              "content.QUIZ_TAB__POPUP_CREATE_QUIZ__TITLE_INPUT_PLACEHOLDER"
            )}
        ...
        <Form.Item
          name="introduction"
          label={t(
            "content.QUIZ_TAB__POPUP_CREATE_QUIZ__INTRODUCTION_INPUT_LABEL"
          )}
        >
          <Input
            type="text"
            name="introduction"
            placeholder={t(
              "content.QUIZ_TAB__POPUP_CREATE_QUIZ__INTRODUCTION_INPUT_PLACEHOLDER"
            )}
            onChange={onInputChange}
          />
        </Form.Item>
        <Form.Item
          name="description"
          label={t(
            "content.QUIZ_TAB__POPUP_CREATE_QUIZ__DESCRIPTION_INPUT_LABEL"
          )}
        >
          <Input
            type="text"
            name="description"
            placeholder={t(
              "content.QUIZ_TAB__POPUP_CREATE_QUIZ__DESCRIPTION_INPUT_PLACEHOLDER"
            )}
            onChange={onInputChange}
          />
        </Form.Item>
