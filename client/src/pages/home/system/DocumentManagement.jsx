...
import { DocumentStatistic, QuizzsStatistic } from "src/sections/@home/base-management";
...
const DocumentManagement = () => {
  const { data: documents, mutate } = useSWR("/auth/statistic/documents?sort=createdAt|desc", (url) => {
    return request
      .get(url, {
        headers: {
